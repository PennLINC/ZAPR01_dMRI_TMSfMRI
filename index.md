<br>
<br>
# CORTICAL-SUBCORTICAL STRUCTURAL CONNECTIVITY SUPPORTS TMS ENGAGEMENT OF THE AMYGDALA
...
<br>
   ...
   - A unique set of study-specific WM, GM, and CSF response functions were generated by averaging response functions from all study subjects via [/mrtrix_csd_fixels/average_responsefunction_5.sh](https://github.com/PennLINC/ZAPR01_dMRI_TMSfMRI/blob/gh-pages/mrtrix_csd_fixels/average_responsefunction_5.sh)
   ...
   - An FOD template mask was generated by running  [/mrtrix_csd_fixels/FOD_populationtemplate_mask_10.sh](https://github.com/PennLINC/ZAPR01_dMRI_TMSfMRI/blob/gh-pages/mrtrix_csd_fixels/FOD_populationtemplate_mask_10.sh)
   - A study-specific Fixel template was created by segmentating template FODs with [/mrtrix_csd_fixels/FixelMask_populationtemplate_11.sh](https://github.com/PennLINC/ZAPR01_dMRI_TMSfMRI/blob/gh-pages/mrtrix_csd_fixels/FixelMask_populationtemplate_11.sh)
