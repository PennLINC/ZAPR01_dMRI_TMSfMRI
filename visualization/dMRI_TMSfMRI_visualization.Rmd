...
plotdata <- data.frame(FD_agecorrected$residuals, vlPFC.TMS.ER.HO25$left_amygdala, vlPFC.TMS.ER.HO25$left_amygdala_sign)
plotdata$vlPFC.TMS.ER.HO25.left_amygdala_sign <- as.factor(plotdata$vlPFC.TMS.ER.HO25.left_amygdala_sign)
...
geom_point(aes(y=abs(vlPFC.TMS.ER.HO25.left_amygdala), x=FD_agecorrected.residuals, color = vlPFC.TMS.ER.HO25.left_amygdala_sign, fill = vlPFC.TMS.ER.HO25.left_amygdala_sign), shape=21, size=4.5) +
